...
public class WebRockModel {
    ...
    public void print() {
        for (Map.Entry<String, Service> entry : services.entrySet()) {
            ...
            System.out.println("Service runOnStart: " + service.getRunOnStart());
            System.out.println("Service priority: " + service.getPriority());
            System.out.println("Inject Session Scope: " + service.getInjectSessionScope());
            System.out.println("Inject Application Scope: " + service.getInjectApplicationScope());
            System.out.println("Inject Request Scope: " + service.getInjectRequestScope());
            System.out.println("Inject Application Directory: " + service.getInjectApplicationDirectory());
            System.out.println("-----------------------------");
        }
    }
}
